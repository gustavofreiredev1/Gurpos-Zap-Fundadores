...
export const Hero: React.FC = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-28 pb-20 overflow-hidden bg-[#07080a]">
      ...
      {/* Grid Pattern Background with Smooth Radial Fade */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-8 my-auto">
        ...
        >
          Transforme seus grupos de WhatsApp em comunidades que <br className="hidden sm:inline" />
          <span className="text-gradient-emerald">crescem todos os dias.</span>
        </motion.h1>
        ...
        >
          Cadastre seus grupos, aumente sua visibilidade, utilize impulsionamentos e participe de um programa de recompensas criado para administradores.
        </motion.p>
        ...
        >
          ...
          >
            <span>Quero cadastrar meu grupo</span>
          ...
          >
            ...
            <span>Conhecer o Programa Fundadores</span>
          </a>
        </motion.div>
        ...
        <motion.div 
          ...
          className="pt-10 grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-4xl mx-auto text-left"
        >
          ...
          <div className="p-4 rounded-2xl glass border border-white/10 space-y-1">
            ...
            <div className="font-display font-bold text-lg text-emerald-400">Milhares de Visitantes</div>
          </div>
